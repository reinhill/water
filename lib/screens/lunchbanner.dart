...
class LunchBanner extends StatefulWidget {
   const LunchBanner({super.key});
  @override
  State<LunchBanner> createState() => _LunchBannerState();
}

class _LunchBannerState extends State<LunchBanner> {
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image: AssetImage('assets/images/shuka.JPG'),
                      fit: BoxFit.cover)),
            ),
             Positioned(
              top: -50.0,
